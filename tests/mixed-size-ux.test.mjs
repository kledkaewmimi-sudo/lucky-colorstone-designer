...
const mixedDescription = String.fromCodePoint(0x0e2a, 0x0e19, 0x0e38, 0x0e01, 0x0020, 0x0e21, 0x0e21, 0x0e15);
...
test('Step 2 keeps four compact vertical cards in the requested mixed-to-4mm order with right-side wrist images', () => {
  ...
  assert.deepEqual([...mixedDescription].map((char) => char.codePointAt(0)), [0x0e2a, 0x0e19, 0x0e38, 0x0e01, 0x0020, 0x0e21, 0x0e21, 0x0e15]);
