...
const { parseCustomizationLoginIntent, restoreLineRedirectHandoff, DEFER_LINE_LOGIN_TO_STEP4 } = await import(`data:text/javascript,${encodeURIComponent(await readFile(new URL('../line-redirect-restore.js', import.meta.url), 'utf8'))}`);
