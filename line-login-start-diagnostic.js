export const LINE_LOGIN_START_DIAGNOSTICS = Object.freeze({
  ...
  LIFF_PROFILE_GET_THROW: Object.freeze({ code: 'F05E3A', branch: 'GET_PROFILE_THROW' }),
  LIFF_PROFILE_MISSING_USER_ID: Object.freeze({ code: 'F05E3B', branch: 'PROFILE_MISSING_USER_ID' }),
  LIFF_PROFILE_STATE_ID_MISSING: Object.freeze({ code: 'F05E3C', branch: 'PROFILE_SYNC_RETURNED_WITHOUT_STATE_ID' }),
